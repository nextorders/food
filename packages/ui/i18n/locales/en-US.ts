export const en = {
  'web-app': {
    'cart': {
      ...
      'delivery-available-until': 'You can order delivery until',
      'pickup': 'Pickup',
      'pickup-details': 'Pickup details',
      'pickup-available-until': 'You can order pickup until',
      'next-label': 'Okay, next',
    ...
    'checkout': {
      ...
      'address': {
        ...
        'floor': 'Floor',
        'note': 'Note',
        'note-placeholder': 'For faster delivery, specify additional information',
      },
      'time-title': 'Time',
      ...
      'order-note': 'Note for kitchen',
      'order-note-placeholder': 'Wishes for order',
    ...
    'finish': {
      'title': 'Order placed',
      'success-message': 'Your request has been successfully submitted for processing.',
      'expect-call': 'Expect a call from the operator.',
      'ordered-title': 'You ordered',
    },
    'search': {
      'placeholder': 'Find a dish',
      'nothing-found': 'Nothing found',
      'most-often': 'Found most often',
    },
    ...
    'maintenance-message': 'The website is under maintenance. Orders are on hold.',
    'tech-support-label': 'Technical support',
    'toast': {
      'in-process': 'In process',
      'updating-data': 'Data is being updated',
    },
  },
  'web-app-selector': {
    'search': 'Search...',
  ...
  'common': {
    ...
    'footer': {
      'copyright': 'Copyright',
      'copyright-part-one': 'Created with',
      'copyright-part-two': 'on',
    },
    'abbreviation': {
      min: 'min',
      kg: 'kg',
    ...
    'nutrition': {
      'value-title': 'Nutritional value per 100 gram',
      'calories': 'Calories',
      'kcal': 'Kcal',
      'protein': 'Protein',
      'fat': 'Fat',
