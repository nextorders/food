...
export const salads: Product[] = [
  {
    ...
    title: [
      ...
      {
        locale: 'pt',
        value: 'Aperitivo picante: salada com frango grelhado',
      },
    ],
    description: [
      {
      ...
      {
        locale: 'pt',
        value: 'Convidamo-lo a saborear uma deliciosa entrada! A nossa salada especial com frango grelhado é a combinação perfeita de frango suculento, legumes frescos e um molho saboroso. Não perca a oportunidade de experimentar este requintado prato no nosso restaurante e comece o dia com energia!',
      },
    ],
  ...
  },
  {
    ...
    title: [
      ...
      {
        locale: 'pt',
        value: '"Redemoinho de Fogo": Salada de Frango Buffalo',
      },
    ],
    description: [
      {
      ...
      {
        locale: 'pt',
        value: 'Convidamo-lo a saborear a deliciosa salada de frango Buffalo no nosso restaurante! Carne de frango tenra, marinada num molho picante, combina na perfeição com folhas de alface, cenoura, aipo e um molho especial de queijo azul. Este prato será uma verdadeira descoberta para os amantes de sabores picantes e combinações inusitadas!',
      },
    ],
    isAvailableForPurchase: true,
    isShownInCatalog: true,
  ...
  },
  {
    ...
    title: [
      ...
      {
        locale: 'pt',
        value: 'Camarão encantador: salada Caesar',
      },
    ],
    description: [
      {
      ...
      {
        locale: 'pt',
        value: 'Experimente o sabor único da salada César com camarão no nosso restaurante! A delicada combinação de camarões suculentos, folhas de salada crocantes e molho saboroso vai conquistá-lo. Uma escolha perfeita para um jantar romântico ou um encontro entre amigos.',
      },
    ],
    isAvailableForPurchase: true,
    isShownInCatalog: true,
  ...
  },
  {
    ...
    title: [
      ...
      {
        locale: 'pt',
        value: '"Flip no Churrasco": uma explosão de sabor e aroma',
      },
    ],
    description: [
      {
      ...
      {
        locale: 'pt',
        value: 'Experimente a nossa salada de frango com molho barbecue, uma combinação perfeita de frango suculento, bacon, tomate e ovos. O sabor delicado e o aroma deste prato ficarão na sua memória durante muito tempo!',
      },
    ],
    isAvailableForPurchase: true,
    isShownInCatalog: true,
  ...
  },
  {
    ...
    description: [
      ...
      {
        locale: 'pt',
        value: 'Descubra o sabor requintado da lendária salada Cobb no nosso restaurante! Esta combinação de frango tenro, abacate suculento, tomate fresco, bacon crocante e queijo gorgonzola aromático vai conquistá-lo. Uma escolha ideal para quem aprecia a verdadeira cozinha americana e pretende desfrutar de um sabor único.',
      },
    ],
    isAvailableForPurchase: true,
    isShownInCatalog: true,
  ...
  },
  {
    ...
    description: [
      ...
      {
        locale: 'pt',
        value: 'Experimente o sabor único da clássica salada César no nosso restaurante! A delicada combinação de folhas de salada suculentas, parmesão aromático e croutons dourados, temperados com um molho inglês especial, proporcionará um prazer gastronómico inesquecível.',
      },
    ],
    isAvailableForPurchase: true,
    isShownInCatalog: true,
  ...
  },
  {
    ...
    title: [
      ...
      {
        locale: 'pt',
        value: 'Explosão cósmica de sabor',
      },
    ],
    description: [
      {
      ...
      {
        locale: 'pt',
        value: 'Descubra uma combinação incrível de vegetais frescos, frango tenro e especiarias aromáticas. Desfrute do sabor único e dê vida às estrelas da sua mesa!',
      },
    ],
    isAvailableForPurchase: true,
    isShownInCatalog: true,
  ...
  },
  {
    ...
    description: [
      ...
      {
        locale: 'pt',
        value: 'A salada grega é uma fonte clássica de frescura e vitaminas. Desfrute da combinação perfeita de tomates maduros, pepinos crocantes, pimentos doces, cebolas roxas e azeitonas tenras. Tempere tudo com azeite aromático e adicione queijo feta autêntico – e a sua mesa transformar-se-á num verdadeiro banquete de sabores!',
      },
    ],
    isAvailableForPurchase: true,
    isShownInCatalog: true,
